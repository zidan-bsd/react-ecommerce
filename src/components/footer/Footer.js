...
const Footer = () => {
  return (
    <footer className=" px-10 py-2 tracking-wide mt-10 bg-Secondary-clr">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-20">
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <p className=" text-Font-gray-clr hover:text-white text-sm">
                Email
              </p>
            </li>
            <li>
      ...
      <p className=" text-Font-gray-clr text-sm mt-10">
        © 2024 Zidan Haryanto All Rights Reserved.
      </p>
    </footer>
  );
};
